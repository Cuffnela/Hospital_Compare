...
##                                                                            ##
## Program reads in data and finds the hospital with the best mortality rate  ##
## for a provided outcome                                                     ##
################################################################################
...
## returns name of hospital with best (lowest) 30-day mortality for given     ##
## outcome in the case of a tie: first alphabetic hospital returned           ##
################################################################################
